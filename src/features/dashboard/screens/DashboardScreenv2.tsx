...
const financialServices = [
   { icon: <Ionicons name="swap-horizontal-outline" size={28} color="#e53935" />, label: 'Chuyển tiền' },
   { icon: <Ionicons name="card-outline" size={28} color="#e53935" />, label: 'Dịch vụ thẻ' },
   { icon: <FontAwesome5 name="piggy-bank" size={24} color="#e53935" />, label: 'Tiết kiệm' },
   { icon: <Ionicons name="cart-outline" size={28} color="#e53935" />, label: 'Mua sắm' },
   { icon: <MaterialIcons name="health-and-safety" size={28} color="#e53935" />, label: 'Bảo hiểm' },
   { icon: <Ionicons name="trending-up-outline" size={28} color="#e53935" />, label: 'Đầu tư' },
   { icon: <MaterialIcons name="attach-money" size={28} color="#e53935" />, label: 'Ngoại tệ' },
   { icon: <Ionicons name="ellipsis-horizontal-circle-outline" size={28} color="#e53935" />, label: 'Khác' },
];
   ...
   return (
      <SafeAreaView style={styles.container} edges={['top']}>
         <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.accountCardWrap}>
               <View style={styles.accountCardBlack}>
                  ...
                  <View style={styles.accountRow}>
                     ...
                     <View style={{ alignItems: 'flex-end' }}>
                        ...
                        <Text style={styles.expValue}>09/25</Text>
                     </View>
                  </View>
               ...
               <View style={styles.accountCardWhite}>
                  <View style={{ flex: 1 }}>
                     ...
                     <Text style={styles.balanceValue}>100,000,000<Text style={styles.vnd}> vnd</Text></Text>
                  </View>
                  <View style={{ flex: 1 }}>
            ...
            <View style={styles.transactionCard}>
               ...
               <View style={styles.transactionRow}>
                  <Ionicons name="airplane-outline" size={28} color="#e53935" style={{ marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
               ...
               {/* 2 */}
               <View style={styles.transactionRow}>
                  <Ionicons name="card-outline" size={28} color="#e53935" style={{ marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
               ...
               {/* 3 */}
               <View style={styles.transactionRow}>
                  <MaterialIcons name="attach-money" size={28} color="#e53935" style={{ marginRight: 10 }} />
                  <View style={{ flex: 1 }}>
         ...
         <View style={styles.bottomNav}>
            ...
            <Pressable style={[styles.navItem, styles.navCenter]} onPress={handleNavigateToScreen}>
               <Animated.View
                  style={{
                     alignItems: 'center',
